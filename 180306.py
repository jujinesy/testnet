...
class FullTV:
    def __init__(self):
        ...
        self.header = {
            ...
            "Cookie": "userLoginSaveYN=Y; PPAP=MQ%3D%3D; userLoginSaveID=aa; sessKey=aa; partner=jjoowonn; userLoginIdx=0; userLoginYN=Y; userReferer=http%3A%2F%2Fwww.full.co.kr%2F;"
        }
